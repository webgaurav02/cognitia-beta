        ...
        <ParallaxLayer offset={0} speed={1}>
          <div className="animation_layer">
            <Image
              ...
              src={prl1}
              alt="background"
              className="w-[900px] sm:w-[1920px] opacity-100 object-cover blur-sm sm:blur-0"
            />
          </div>
        </ParallaxLayer>
        ...
        <ParallaxLayer offset={0.1} speed={1.3}>
          <div className="animation_layer">
            <Image
              ...
              src={prl2}
              alt="background"
              className="w-[900px] sm:w-[1920px] opacity-100 object-cover blur-[2px] sm:blur-0"
            />
          </div>
        </ParallaxLayer>
        ...
        <ParallaxLayer offset={0.3} speed={1.5}>
          <div className="animation_layer">
            <Image
              ...
              src={prl3}
              alt="background"
              className="w-[900px] sm:w-[1920px] opacity-100 object-cover blur-[1px] sm:blur-0"
            />
          </div>
        </ParallaxLayer>
