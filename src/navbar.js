...
export default function NavBar() {
  ...
  return (
    <>
      <div class="w-full z-50 h-10 sm:h-24 backdrop-filter backdrop-blur-md border-b border-gray-200 bg-opacity-40 sticky top-0 bg-[#101010] pr-6 pl-6 md:pr-12 md:pl-12">
        <div className="h-full flex flex-row justify-between content-center">
          <div className="text-neutral-200 md:text-[30px] self-center font-medium text-2xl">
            <img className="w-[40px] h-[40px] sm:w-[80px] sm:h-[80px]" src={Logo} />
          </div>
