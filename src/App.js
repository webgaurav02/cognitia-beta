...
function App() {
  return (
    ...
    <div className='font-poppins w-screen h-[768px] xl:h-[500px] 2xl:h-[768px] text-white -translate-y-[95vh] 2xl:-translate-y-full absolute'> 
      <div className=' px-2 md:px-36 grid grid-rows-7 grid-cols-5 pt-52 sm:pt-0 sm:h-full '>
        <div className=' py-2 sm:py-0 row-span-2 col-span-3 lg:col-span-2 text-6xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-7xl 2xl:text-9xl self-end hover:bg-white peer/title hover:text-black duration-500'>COGNITIA 2K23 FEST</div>
        <div className='flex justify-end content-center row-span-6 lg:col-span-3 '> </div>
        <div className=' py-2 sm:py-0 row-span-2 col-span-2 text-md sm:text-xl md:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl text-gray-400 self-center peer-hover/title:bg-white peer-hover/title:text-black hover:bg-white hover:text-black duration-500'>Welcome to Cognitia, NIT Meghalaya’s annual tech and cultural fest. Explore all events and get registered now! </div>
